...
************************************************************************
! @Description("plant growth calculation")
! @VersionInfo("$Id$")
! @DSSAT(control="DYN", states="RATE INTEGR OUTPT")  
! @Execute
      SUBROUTINE PLANT(
     &    DOY, DOYP, endsim, TMAX, TMIN, PAR, SWFAC1, SWFAC2,   !Input
     &    LAI,                                            !Output
...
!************************************************************************
        WRITE(1,20) DOY,n,int,w,wc,wr,wf,lai, SWFAC1, SWFAC2
   20   FORMAT(I5,7F8.2,2F8.3)
   ...
   30     FORMAT(2/)
        ...
        COUNT = COUNT + 1
        WRITE(*,20) DOY,n,int,w,wc,wr,wf,lai, SWFAC1, SWFAC2
...
*****************************************************************************
*     Subroutine PGS
*     Calculates the canopy gross photosysnthesis rate (PG)
******************************************************************************
