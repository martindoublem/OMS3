...
// graphs & plots
    ...
    public static Object simgraph_run(LinkedHashMap props, Closure closure) throws Exception {
        return runSimulation("simgraph", props, closure);
    }
...
//            Object model = ((AbstractSimulationGraph) simu).run();
//            ((AbstractSimulationGraph) simu).setModelComponent(model);
//            return simu;
//        } else {
            Object simu = sb.invokeMethod(name, new Object[]{props, closure});
