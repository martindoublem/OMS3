 ...
 * @author od
 */
abstract public class AbstractSimulation extends GraphMemoryBuffer implements Buildable {
    ...
    public Integer numCores = null;
    public Boolean calibrate = null;
    public Boolean paramsoverwrite = null;
    protected Properties properties = null;
    protected ParamFiles paramFiles = null;
    public ConcurrentLinkedDeque<String> setpath = null;
    String name;
    ...
    public void setParamsoverwrite(Boolean paramsoverwrite) {
    ...
    public Object getModel() {
        if (model == null && graph == null) {
            throw new ComponentException("No model or graph component available as a part of this simulation.");
        } else if ( model != null) {
            return modelComp;
        } else {
            return graph;
    ...
    public Graph getGraphStructure() {
        return graph;
    }
    ...
    public void calibrationGraphParameters(UnifiedParams calibvars) {
        this.calibvars = calibvars;
    }
    ...
    public Buildable create(Object name, Object value) {
        if (name.equals(Model.DSL_NAME)) {
            ...
            model.setRes(res);
            return model;
        } else if (name.equals(Graph.DSL_NAME)) {
            if (graph != null) {
                throw new ComponentException("Only one 'model' element allowed.");
            }
            graph = new Graph();
            ...
            return properties;
        } else if (name.equals("paramfiles")) {
            paramFiles = new ParamFiles();
            return paramFiles;
    ...
    protected void initRun() {
        setSystemProperties();
        if (getModelElement() == null && getGraphStructure() == null) {
            throw new ComponentException("missing 'model' or 'graph' element.");
        }
    }
