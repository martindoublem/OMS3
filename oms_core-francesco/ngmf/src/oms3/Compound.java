...
public class Compound {
     ...
     */
    public void graph_in2in(String from_node, String from, Object to, String to_out) {
        controller.mapIn(from_node, from, to, to_out);
    }


    public void graph_subtrees(String node, Object to, String to_out) {
        controller.mapSubTreeIn(node, to, to_out);
    }
     ...
     * @param to_out output field of the internal component
     */
    public void graph_out2out(String node, String out, Object to) {
        controller.mapGrOut(node, out, to);
    }
