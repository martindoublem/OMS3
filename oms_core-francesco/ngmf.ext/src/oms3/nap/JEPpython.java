...
public class JEPpython implements AnnotationHandler {
    ...
    public void done() throws Exception {
        ...
        w.println();
        w.println("        Jep jep = new Jep(false);");
        w.println("        try {");
        w.println();
        ...
        //w.println("            jep.runScript(System.getProperty(\"user.dir\") + \"/src/\" + \"" + srcFile.getAbsoluteFile().toString().replace('\\', '/').split("/src/")[1] + "\");");
        ...
        w.println("            jep.set(\"pathName\", pathName);");
        w.println("            jep.set(\"scriptName\", scriptName);");
        w.println("            jep.eval(\"import zipfile\");");
        w.println("            jep.eval(\"zf = zipfile.ZipFile(pathName)\");");
        w.println("            jep.eval(\"file = zf.read(scriptName)\");");
        w.println("            jep.eval(\"exec(file)\");");
        ...
        w.println("            System.out.println(\"***********************************************\");");
        w.println("            System.out.println(\"Python-OMS component \" + this.getClass().getSimpleName());");
