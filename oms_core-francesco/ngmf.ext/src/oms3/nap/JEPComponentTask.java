 ...
 */
public class JEPComponentTask extends Task {
...
//        List<JEPpython> jep_py = new ArrayList<>();
            ...
            for (FileSet fs : filesets) {
                ...
                for (String incFile : ds.getIncludedFiles()) {
                    if (needsRebuild(baseDir, destdir, incFile)) {
                        ...
                        JEPpython ah = new JEPpython(this) {
                            @Override
                            public void log(String msg) {
                                JEPComponentTask.this.log(msg, Project.MSG_VERBOSE);
                            }
                        };
