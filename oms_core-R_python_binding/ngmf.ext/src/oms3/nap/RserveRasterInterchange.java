...
public class RserveRasterInterchange {
    ...
    private void r2jRasterTransfer() {
        ...
        try {
            ...
            w.println("import org.geotools.resources.coverage.CoverageUtilities;");
            w.println("import org.opengis.coverage.processing.Operation;");
            w.println("import org.opengis.parameter.ParameterValueGroup;");
            w.println("import org.rosuda.REngine.REXP;");
            w.println("import org.rosuda.REngine.REXPDouble;");
            ...
            w.println("        CoverageProcessor processor = CoverageProcessor.getInstance();");
            w.println("        Operation operation = processor.getOperation(\"Scale\");");
            w.println("        ParameterValueGroup para = operation.getParameters();");
            w.println("        para.parameter(\"Source0\").setValue(gc);");
            w.println("        para.parameter(\"backgroundValues\").setValue(new double[]{-9999.0});");
            w.println("        return (GridCoverage2D) processor.doOperation(para);");
            w.println("    }");
            w.println();
