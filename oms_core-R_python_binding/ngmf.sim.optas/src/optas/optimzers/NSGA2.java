...
import optas.utils.SampleFactory.SampleComperator;
import optas.utils.SampleLimitException;
import test.LeafRiverExample;
...
public class NSGA2 extends Optimizer {
    ...
    public void procedure() throws SampleLimitException, ObjectiveAchievedException {
        try {
             ...
             * *********************************************************************
             */
            log(("NO_OF_MUTATION") + this.crossoverCount);
            log(("NO_OF_CROSSOVER") + this.mutationCount);
            log("-----------------------------------------------------------------------------------");
