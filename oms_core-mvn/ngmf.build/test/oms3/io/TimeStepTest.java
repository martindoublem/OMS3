...
public class TimeStepTest {
    ...
    @Test
    public void testTimeStep_USER_TIME() throws Exception {
        printDebug("----------------------------");
        printDebug("USER_TIME: " + this.toString());
        printDebug("----------------------------");
        ...
        double[] obsval = DataIO.getColumnDoubleValuesInterval(start, end, t, "runoff[0]", DataIO.TIME_STEP);
