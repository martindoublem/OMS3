...
/*
 * This class acts like a StringBuffer which defines new types of append methods. It defines certain
 * functionalities of the ANSI C printf function that also can be accessed through static methods.
 * The information given here is strongly inspired from the man page of the C printf function. Most
 * methods of this class format numbers for the English US locale only. One can use the Java class
 * @link java.util.Formatter  for performing locale-independent formatting.
 */
public class PrintfFormat implements CharSequence, Appendable {
    ...
    /*
     * Uses the  #s(int,String) s static method to append str to the buffer. A minimum of fieldwidth
    ...
    /*
     * Uses the #f(int,double) f static method to append x to the buffer. A minimum of 
    ...
    /*
     * Uses the #f(int,int,double) f static method to append x the buffer. A minimum of 
     * fieldwidth characters will be used with the given precision.
     * @param fieldwidth minimum length of the converted string to be appended
    ...
    /*
     * Uses the #d(int,long) d static method to append x to the buffer. A minimum of 
     * fieldwidth characters will be used.
     * @param fieldwidth minimum length of the converted string to be appended
     * @param x value to be appended to the buffer
     * @return this object
    ...
    /*
     * Uses the #format(int,int,int,double) format static method with the same four arguments to
     * append x to the buffer.
     * @param fieldwidth minimum length of the converted string to be appended
    ...
    /*
     * Same as #s(int,String) s (0, str). If the string str is null, it returns the string ``null''.
    ...
    /*
     * Formats the string str like the %s in the C printf function. The fieldwidth argument gives
     * the minimum length of the resulting string. If str is shorter than fieldwidth, it is
     * left-padded with spaces. If fieldwidth is negative, the string is right-padded with spaces
     * if necessary. The String will never be truncated. If str is null, it calls #s(int, String) s
     * (fieldwidth, ``null''). The fieldwidth argument has the same effect for the other methods in 
     * this class.
    ...
    /*
     * Same as #d(int,int,long) d (0, 1, x).
    ...
    /*
     * Same as #d(int,int,long) d (fieldwidth, 1, x).
     * @param fieldwidth minimum length of the returned string
     * @param x the string to process
     * @return the same string, padded with spaces or zeros if appropriate
     */
    ...
    /*
     * Formats the long integer x into a string like %d in the C printf function. It converts its
     * argument to decimal notation, precision gives the minimum number of digits that must appear;
     * if the converted value requires fewer digits, it is padded on the left with zeros. When zero
    ...
    /*
     * Converts a long integer to a String with a minimum length of fieldwidth, the result is 
     * right-padded with spaces if necessary but it is not truncated. If only one argument is
     * specified, a fieldwidth of 0 is assumed.
     * @param fieldwidth minimum length of the returned string
     * @param x the value to be processed
     * @return the string resulting from the conversion
     */
    ...
    /*
     * Same as #formatBase(int,int,long) formatBase (0, b, x).
    ...
    /*
     * Converts the integer x to a String representation in base b. Restrictions: 2 <= b <= 10.
     * @param fieldwidth minimum length of the returned string
     * @param b the base used for conversion
     * @param x the value to be processed
     * @return a string representing x in base b
    ...
    /*
     * Same as #E(int,int,double) E (0, 6, x).
    ...
    /*
     * Same as #E(int,int,double) E (fieldwidth, 6, x).
     * @param fieldwidth minimum length of the returned string
     * @param x the value to be converted to string
     * @return the converted value as a string
     */
    ...
    /*
     * Formats a double-precision number x like %E in C printf. The double argument is rounded and
     * converted in the style [-]d.dddE+-dd where there is one digit before the decimal-point 
     * character and the number of digits after it is equal to the precision; if the precision is 0,
     * no decimal-point character appears. The exponent  always contains at least two digits; if the
    ...
    /*
     * Same as #f(int,int,double) f (0, 6, x).
     * @param x the value to be converted to string
     * @return the converted value as a string
     */
    ...
    /*
     * Same as #f(int,int,double) f (fieldwidth, 6, x).
     * @param fieldwidth minimum length of the returned string
     * @param x the value to be converted to string
     * @return the converted value as a string
     */
    ...
    /*
     * Formats the double-precision x into a string like %f in C printf. The argument is rounded 
     * and converted to decimal notation in the style [-]ddd.ddd, where the number of digits after
     * the decimal-point character is equal to the precision specification. If the precision is
     * explicitly 0, no decimal-point character appears. If a decimal point appears, at least
    ...
    /*
     * Same as #G(int,int,double) G(0, 6, x).
     * @param x the value to be converted to string
     * @return the converted value as a string
     */
    ...
    /*
     * Same as #G(int,int,double) G(fieldwidth, 6, x).
     * @param fieldwidth minimum length of the returned string
     * @param x the value to be converted to string
     * @return the converted value as a string
     */
    ...
    /*
     * Formats the double-precision x into a string like %G in C printf. The argument is converted
     * in style %f or %E. precision specifies the number of significant digits. If it is 0, it is 
     * treated as 1. Style %E is used if the exponent from its conversion is less than -4 or
     * greater than or equal to precision. Trailing zeros are removed from the fractional part of 
    ...
    public static String G (int fieldwidth, int precision, double x) {
        ...
        // Calculate the scientific notation format. We cannot use E because it can make 
        //trailing zeros that must be removed afterward.
        DecimalFormat df;
        ...
        /*
         * We need the number of digits after the decimal point to get precisions significant digits.
         * The integer part of x contains at most precision digits. If that was not true, expval would
         * be greater than precision. If expval=0, we have a number of the form 1.234... To have 
         * precisions significant digits, we need precision-1 digits. If expval<0, x<1 and we need
         * -expval additionnal decimal digits.
    ...
    /*
     * Returns a String containing x. Uses a total of at least fieldwidth positions (including the
     * sign and point when they appear), accuracy digits after the decimal point and at least 
     * precision significant digits. accuracy and precision must be strictly smaller than fieldwidth.
     * The number is rounded if necessary. If there is not enough space to format the number in 
     * decimal notation with at least precision significant digits (accuracy or fieldwidth
     * is too small), it will be converted to scientific notation with at least precision significant
     * digits. In that case, fieldwidth is increased if necessary.
     * @param fieldwidth minimum length of the returned string
     * @param accuracy number of digits after the decimal point
     * @param precision number of significant digits
     * @param x the value to be processed
    ...
    public static String format (int fieldwidth, int accuracy, int precision, double x) {
        ...
        if (canUseDecimalNotation(fieldwidth, accuracy, precision, x)) {
            ...
            return processExp( E(fieldwidth, precision - 1 , x) );
        }
    }
    
    private static boolean canUseDecimalNotation (int fieldwidth, int accuracy,
            int precision, double x) {
        //The number of positions occupied by la partie entiere de x
        int PosEntier = 0;
        //The Number of significant digits before the decimal
        int EntierSign;
        //The position of the exponent in string S and the length of S
        int Neg = 0;
    ...
    /*
     * This method is equivalent to #format(int,int,int,double) format, except it formats the given
    ...
    public static String format (Locale locale, int fieldwidth, int accuracy,
        ...
        if (canUseDecimalNotation (fieldwidth, accuracy, precision, x)) {
            ...
            return processExp(fmt.format("%" + fieldwidth + "." + (precision - 1) + "E", x).toString());
        }
    }
    
    /*
     * Converts x to a String representation in base b using formatting similar to the f methods. 
     * Uses a total of at least fieldwidth positions (including the sign and point when they appear)
     * and accuracy digits after the decimal point. If fieldwidth is negative, the number is
     * printed  left-justified, otherwise right-justified. Restrictions:
     * 2 <= b <= 10 and | x | < 2^63.
     * @param fieldwidth minimum length of the returned string
     * @param accuracy number of digits after the decimal point
     * @param b base
     ...
     * both strings being formatted with the same notation. Uses a total of at least
     * fieldwidth positions (including the sign and point when they appear) for x,
     * fieldwidtherr positions for error, accuracy digits after the decimal point and at 
     * least precision significant digits. accuracy and precision must be strictly
     * smaller than fieldwidth. The numbers are rounded if necessary. If there is not enough
     * space to format x in decimal notation with at least precision significant digits 
     * (accuracy or fieldwidth are too small), it will be converted to scientific
     * notation with at least precision significant digits. In that case, fieldwidth is 
     * increased if necessary, and the error is also formatted in scientific notation.
     ...
     */
    public static void formatWithError (int fieldwidth, int fieldwidtherr, int accuracy,
    ...
    /*
     * Stores a string containing x into res[0], and a string containing error into res[1], both
     * strings being formatted with the same notation. This calls 
     * #formatWithError(int,int,int,int,double,double,String[]) formatWithError with the minimal
     * accuracy for which the formatted string for error is non-zero. If error is 0, the accuracy
     * is 0. If this minimal accuracy causes the strings to be formatted using scientific
     ...
     * @param res an array that will be filled with the formatted value and formatted error
     */
    public static void formatWithError (int fieldwidth, int fieldwidtherr, int precision, 
    ...
    /*
     * This method is equivalent to #formatWithError(int,int,int,double,double,String[]) formatWithError,
     * except that it formats the given value and error for the locale locale.
     ...
     * @param res an array that will be filled with the formatted value and formatted error
     */
    public static void formatWithError (Locale locale, int fieldwidth, int fieldwidtherr, 
        ...
        if (canUseDecimalNotation(fieldwidth, accuracy, precision, x)) {
            ...
            res[1] = processExp(fmtErr.format("%" + fieldwidtherr + "." + errorPrecision +
                    "E", error).toString());
        }
    }
