...
public class ConversionTest {
    ...
    @Test
    public void testArrayParser1() {
        String[] arr = Conversions.parseArrayElement("test");
        Assert.assertNotNull(arr);
    ...
    @Test
    public void testArrayParser2() {
        String[] arr = Conversions.parseArrayElement("test[1][24][3]");
        Assert.assertNotNull(arr);
    ...
    public void testFloat() {
        String content = "2.31";
        float bd = Conversions.convert(content, Float.class);
        Assert.assertEquals(2.31, bd, 0.00001);

        Float bd1 = Conversions.convert(content, Float.class);
        Assert.assertEquals(2.31, bd1, 0.00001);
    }

    @Test
    public void testBoolean() {
        String content = "true";
        boolean bd = Conversions.convert(content, Boolean.class);
    ...
    public void testString() {
        String content = "true";
        String bd = Conversions.convert(content, String.class);
        Assert.assertEquals(content, bd);
    }
