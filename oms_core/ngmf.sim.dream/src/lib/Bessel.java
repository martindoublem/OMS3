...
public class Bessel extends Constants {
     ...
     ****************************************/
    /*
     * Chebyshev coefficients for K0(x) + log(x/2) I0(x) in the interval [0,2].  The odd order 
     * coefficients are all zero; only the even order coefficients are listed.
    ...
    /*
     * Returns the modified Bessel function of order 0 of the argument. The function is defined
     * as i0(x) = j0( ix ). The range is partitioned into the two intervals [0,8] and
     * (8, infinity). Chebyshev polynomial expansions are employed in each interval.
    ...
    /*
     * Returns the exponentially scaled modified Bessel function of order 0 of the argument. The 
     * function is defined as i0e(x) = exp(-|x|) j0( ix ).
     * @param x the value to compute the bessel function of.
     */
    ...
    /*
     * Returns the modified Bessel function of order 1 of the argument. The function is defined
     * as i1(x) = -i j1( ix ). The range is partitioned into the two intervals [0,8] and
     * (8, infinity). Chebyshev polynomial expansions are employed in each interval.
     * @param x the value to compute the bessel function of.
     */
    ...
    /*
     * Returns the exponentially scaled modified Bessel function of order 1 of the argument. The 
     * function is defined as i1(x) = -i exp(-|x|) j1( ix ).
     * @param x the value to compute the bessel function of.
     */
    ...
    static public double j0(double x) throws ArithmeticException {
        ...
        if( (ax = Math.abs(x)) < 8.0 ) {
            double y = x * x;
            double ans1 = 57568490574.0 + y * (-13362590354.0 + y * (651619640.7 + y * 
                    (-11214424.18 + y * (77392.33017 + y * (-184.9052456)))));
            double ans2 = 57568490411.0 + y * (1029532985.0 + y * (9494680.718 + y * 
            ...
            double ans1 = 1.0 + y * (-0.1098628627e-2 + y * (0.2734510407e-4 + y * 
                    (-0.2073370639e-5 + y * 0.2093887211e-6)));
            double ans2 = -0.1562499995e-1 + y * (0.1430488765e-3 + y * 
    ...
    /*
     * Returns the modified Bessel function of the third kind of order 0 of the argument. The 
     * range is partitioned into the two intervals [0,8] and (8, infinity).  Chebyshev polynomial
    ...
    /*
     * Returns the modified Bessel function of the third kind of order 1 of the argument. The 
     * range is partitioned into the two intervals [0,2] and (2, infinity). Chebyshev polynomial
     * expansions are employed in each interval.
     * @param x the value to compute the bessel function of.
     */
    ...
    /*
     * Returns the modified Bessel function of the third kind of order nn of the argument. The
     * range is partitioned into the two intervals [0,9.55] and (9.55, infinity). An ascending power 
     * series is used in the low range, and an asymptotic expansion in the high range.
    ...
    static public double y0(double x) throws ArithmeticException {
        if (x < 8.0) {
            double y = x * x;
            double ans1 = -2957821389.0 + y * (7062834065.0 + y * (-512359803.6 + y * 
                    (10879881.29 + y * (-86327.92757 + y * 228.4622733))));
            double ans2 = 40076544269.0 + y * (745249964.8 + y * (7189466.438 + y * 
    ...
    static public double y1(double x) throws ArithmeticException {
        if (x < 8.0) {
            double y = x * x;
            double ans1 = x * (-0.4900604943e13 + y * (0.1275274390e13 + y * 
                    (-0.5153438139e11 + y * (0.7349264551e9 +y * (-0.4237922726e7 + y * 0.8511937935e4)))));
            double ans2 = 0.2499580570e14 + y * (0.4244419664e12 + y * (0.3733650367e10 + y * 
            ...
            double ans1 = 1.0 + y * (0.183105e-2 + y * (-0.3516396496e-4 + y * 
                    (0.2457520174e-5 + y * (-0.240337019e-6))));
            double ans2 = 0.04687499995 + y * (-0.2002690873e-3 + y * (0.8449199096e-5 + y * 
                    (-0.88228987e-6 + y * 0.105787412e-6)));
            return Math.sqrt(0.636619772 / x) * (Math.sin(xx) * ans1 + z * Math.cos(xx) * ans2);
	}
    }
